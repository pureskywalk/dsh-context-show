		...
		*/
		const ContextShowSettings = (0, react.memo)(function ContextShowSettings(props) {
			...
			const patchPrice = (record, key, field, peak, raw) => {
				...
				setDraft((prev) => {
					...
					if (peak) nextTarget = {
						...
						const peakOverride = target.peak === void 0 ? void 0 : { ...target.peak };
						if (peakOverride !== void 0) delete peakOverride[field];
						nextTarget = {
							...target,
							[field]: numeric,
							...peakOverride === void 0 ? {} : { peak: peakOverride }
						};
					}
			...
			return shell((0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				Object.entries(draft.prices).map(([key, price]) => (0, react_jsx_runtime.jsxs)("div", {
				...
				Object.entries(draft.modelPrices).map(([key, price]) => (0, react_jsx_runtime.jsxs)("div", {
					className: ContextShowSettings_module_css_default.entryCard,
					children: [(0, react_jsx_runtime.jsxs)("div", {
						className: ContextShowSettings_module_css_default.entryHeader,
						children: [(0, react_jsx_runtime.jsx)("input", {
		...
		const zh = {
			...
			"settings.note": "单价单位为每百万 token。保存后即时生效（主机投影重新计价）；当前默认值为 DeepSeek 8/17 前的平价。",
			"settings.save": "保存",
			"settings.reset": "恢复默认"
		};
		...
		const en = {
			...
			"settings.note": "Prices are per 1M tokens. Saving applies immediately (the host projection reprices); defaults are DeepSeek flat rates before 2026-08-17.",
			"settings.save": "Save",
