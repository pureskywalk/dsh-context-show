    ...
    const todaySpend = useMemo(() => {
        ...
        for (const [id, summary] of Object.entries(sessionsById)) {
            ...
            if (cost === undefined)
                continue;
            total += cost;
            if (currentCwd !== undefined && summary.cwd === currentCwd)
                workspace += cost;
        }
